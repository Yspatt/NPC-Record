...
import com.yan.minecraft.npc.data.npc.customplayer.CustomPlayer_1_15_R1;
...
public class NPC_1_15_R1 implements NPC {
    ...
    private CustomPlayer_1_15_R1 entityPlayer;
    private String name;
    private String skin;
    ...
    public void spawn() {
        ...
        entityPlayer = new CustomPlayer_1_15_R1(nmsServer, worldServer, gameProfile);
    ...
    public void sneak(boolean b) {
        ...
        dw.register(new DataWatcherObject<>(6, DataWatcherRegistry.s), (b ? EntityPose.CROUCHING : EntityPose.STANDING));
